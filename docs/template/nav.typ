#html.elem("div", attrs: (
    class: "dark:prose-invert dark:text-white prose-li:first:mt-0 prose-ol:p-0 prose-a:underline-offset-2 prose-li:p-0 prose-ol:m-0",
))[
    #html.elem(
        "div",
        attrs: (
            class: "prose-a:text-current prose-a:font-normal prose-a:decoration-0 mb-12",
        ),
    ...
    #html.elem("div", attrs: (class: "prose-sm mb-6 mt-2.5"))[
        Got a question? \
        Ask it on the #link("https://github.com/l0uisgrange/zap/discussions/categories/q-a")[community forum].
    ]
    #html.elem(
        "svg",
        attrs: (
    ...
    #html.elem("div", attrs: (class: "prose-sm mt-2"))[
        Experienced a bug? \
        Please #link("https://github.com/l0uisgrange/zap/issues/new?template=bug_report.yml")[report] it.
    ]
]

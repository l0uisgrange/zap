...
<div class="w-full! items-stretch bg-neutral-50 md:flex dark:bg-neutral-950">
	<article class="min-h-dvh max-w-full flex-auto overflow-hidden p-5 pt-10 md:px-10 md:py-10">

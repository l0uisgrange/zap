...
<div class="md:flex md:items-stretch">
	<main class="min-h-dvh flex-auto p-5 pt-10 md:px-8 md:py-10">
		...
		<p class="max-w-2xl text-lg">
			Draw electronic circuits effortlessly in Typst with Zap. Powered by CeTZ, it offers simple functions to place and connect symbols directly
			in your documents.
		</p>
		<h2>Installation</h2>
		<p>
		...
		<NexPrev next={{ href: '/docs/basics', title: 'Basics' }} />
	</main>

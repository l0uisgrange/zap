...
<button
	...
	class="dark:border-neutral-800 flex w-full cursor-pointer items-center justify-between border-b border-neutral-200 px-5 py-2.5 md:hidden"
>
	Menu
	<span class="icon-[hugeicons--arrow-down-01] size-6 transition {menuopen && 'rotate-180'}"></span>
</button>
<div class="relative md:flex h-full">
    <div class="dark:border-neutral-800 {!menuopen &&
                'hidden'} md:block flex-none space-y-1 border-r-0 border-b border-neutral-200 p-5 md:w-72 md:border-r md:border-b-0">
        <div
            class="md:sticky top-24"
        >

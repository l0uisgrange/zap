import{t as m,a as c}from"../chunks/C-hBxsOW.js";import"../chunks/C-km6zZ8.js";import{$ as p,c as a,e as o,r as t}from"../chunks/DhzbSWZ_.js";import{h as d}from"../chunks/C_g7wnIQ.js";import{s as u}from"../chunks/h7lXfR73.js";import{C as v}from"../chunks/BtYiqYoW.js";const g=""+new URL("../assets/example1.DtUNQ4yC.svg",import.meta.url).href;var b=m(`<main class="block p-5 py-10"><h1>Examples</h1> <p class="max-w-2xl text-lg">Explore the examples below to see Circuitor's advanced capabilities in action and discover
		just how easy it is to program complex circuit diagrams.</p> <h2>Simple example</h2> <div class="grid gap-7 md:grid-cols-2"><div class="dark:border-neutral-border flex items-center justify-center overflow-scroll rounded-lg border border-neutral-200 bg-white"><img alt="example1" class="p-10"></div> <!></div></main>`);function E(s){var r=b();d(h=>{p.title="Getting started"});var i=o(a(r),6),e=a(i),l=a(e);u(l,"src",g),t(e);var n=o(e,2);v(n,{content:`#circuitor.canvas({
    import circuitor: *

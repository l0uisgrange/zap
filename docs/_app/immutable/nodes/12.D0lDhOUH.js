import{f as b,a as u}from"../chunks/oJKTXW1w.js";import"../chunks/DGKY0cM1.js";import{t as h,$ as f,f as a,c as e,r}from"../chunks/DVT4hDLY.js";import{h as x}from"../chunks/B7ldBpxJ.js";import{b as i}from"../chunks/KwVppFjo.js";import{C as m}from"../chunks/DGzpS7Y4.js";const w=""+new URL("../assets/example1.DtUNQ4yC.svg",import.meta.url).href,$=""+new URL("../assets/example2.CF_ci4HO.svg",import.meta.url).href;var _=b(`<main class="block p-5 py-10"><h1>Examples</h1> <p class="max-w-2xl text-lg">Explore the examples below to see Zap's advanced capabilities in action and discover just how easy it is to program complex circuit diagrams.</p> <h2>Simple example</h2> <div class="grid gap-7 md:grid-cols-2"><div class="dark:border-neutral-border flex items-center justify-center overflow-scroll rounded-lg border border-neutral-200 bg-white"><img alt="example1" class="p-10"/></div> <!></div> <h2>Wheatstone bridge</h2> <div class="grid gap-7 md:grid-cols-2"><div class="dark:border-neutral-border flex items-center justify-center overflow-scroll rounded-lg border border-neutral-200 bg-white"><img alt="example2" class="p-10"/></div> <!></div></main>`);function k(d){var t=_();x(C=>{f.title="Getting started"});var o=a(e(t),6),l=e(o),c=e(l);r(l);var p=a(l,2);m(p,{content:`#zap.canvas({
    ...
    // Wiring
    wire("r2.out", "r3.out")
})`}),r(o);var n=a(o,4),s=e(n),v=e(s);r(s);var g=a(s,2);m(g,{content:`#zap.canvas({
    import zap: *

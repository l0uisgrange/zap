import{t as u,a as b}from"../chunks/CWsMwKfg.js";import"../chunks/DLLSUgow.js";import{$ as h,d as a,c as e,r}from"../chunks/aBwqe7DS.js";import{h as x}from"../chunks/CFRSe7AF.js";import{s as i}from"../chunks/CbD643Zc.js";import{C as d}from"../chunks/KQkJXVbP.js";const f=""+new URL("../assets/example1.DtUNQ4yC.svg",import.meta.url).href,w=""+new URL("../assets/example2.CF_ci4HO.svg",import.meta.url).href;var $=u(`<main class="block p-5 py-10"><h1>Examples</h1> <p class="max-w-2xl text-lg">Explore the examples below to see Zap's advanced capabilities in action and discover just
		how easy it is to program complex circuit diagrams.</p> <h2>Simple example</h2> <div class="grid gap-7 md:grid-cols-2"><div class="dark:border-neutral-border flex items-center justify-center overflow-scroll rounded-lg border border-neutral-200 bg-white"><img alt="example1" class="p-10"></div> <!></div> <h2>Wheatstone bridge</h2> <div class="grid gap-7 md:grid-cols-2"><div class="dark:border-neutral-border flex items-center justify-center overflow-scroll rounded-lg border border-neutral-200 bg-white"><img alt="example2" class="p-10"></div> <!></div></main>`);function W(m){var t=$();x(_=>{h.title="Getting started"});var l=a(e(t),6),o=e(l),c=e(o);i(c,"src",f),r(o);var p=a(o,2);d(p,{content:`#zap.canvas({
    import zap: *
    ...
    // Wiring
    wire("r2.out", "r3.out")
})`}),r(l);var n=a(l,4),s=e(n),v=e(s);i(v,"src",w),r(s);var g=a(s,2);d(g,{content:`#zap.canvas({
    import zap: *
    ...
    wire("v1.plus", "r4.out")
})`}),r(n),r(t),b(m,t)}export{W as component};

...
#let component(uid, position1, position2, draw, variant: "european", scale: 1.0, rotate: 0deg, stroke: luma(0%), stroke-width: 1pt, ..params) = {
    ...
    assert(type(position1) == array, message: "position must be an array of 2 floats")
